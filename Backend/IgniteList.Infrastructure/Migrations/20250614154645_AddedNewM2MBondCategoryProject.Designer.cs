...
namespace IgniteList.Infrastructure.Migrations
{
    ...
    [Migration("20250614154645_AddedNewM2MBondCategoryProject")]
    partial class AddedNewM2MBondCategoryProject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Spiderly.Security.Entities.UserRole", b =>
                {
                    ...
                    b.HasOne("IgniteList.Business.Entities.UserExtended", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
