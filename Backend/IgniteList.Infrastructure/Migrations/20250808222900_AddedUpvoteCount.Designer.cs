...
namespace IgniteList.Infrastructure.Migrations
{
    ...
    [Migration("20250808222900_AddedUpvoteCount")]
    partial class AddedUpvoteCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IgniteList.Business.Entities.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("IgniteList.Business.Entities.ProjectCategory", b =>
                {
            ...
            modelBuilder.Entity("IgniteList.Business.Entities.Upvote", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("IgniteList.Business.Entities.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("IgniteList.Business.Entities.UserNotification", b =>
                {
            ...
            modelBuilder.Entity("IgniteList.Business.Entities.Project", b =>
                {
                    b.HasOne("IgniteList.Business.Entities.User", "User")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("IgniteList.Business.Entities.ProjectCategory", b =>
                {
                    b.HasOne("IgniteList.Business.Entities.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IgniteList.Business.Entities.Project", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("IgniteList.Business.Entities.UserNotification", b =>
                {
                    b.HasOne("IgniteList.Business.Entities.Notification", "Notification")
                        .WithMany()
            ...
            modelBuilder.Entity("Spiderly.Security.Entities.UserRole", b =>
                {
                    ...
                    b.HasOne("IgniteList.Business.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
